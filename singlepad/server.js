...
var db = SubLevel(level('./persist_codeshare'))
var sbDb = db.sublevel('scuttlebuttcodeshare')
var level_scuttlebutt = require("level-scuttlebutt")
var seaport = require('seaport');
var ports = seaport.connect(9091);
var port = ports.register('singlepad@0.1.0');

level_scuttlebutt(sbDb, udid('singlepad'), function ( name ){
